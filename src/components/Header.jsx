...
export default function Header() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-red-900/50 backdrop-blur-md z-50">
      <div className="flex justify-between items-center px-4 py-2 sm:px-8 sm:py-3">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <img src={logo} alt="Logo" className="w-[48px] sm:w-[60px]" />
        </div>
